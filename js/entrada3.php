...
?>
<!DOCTYPE html>
<html lang="en" ng-app="moduloProducto">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
         <div class="container-fluid">
          ...
          <h1 class="h3 mb-0 text-gray-800">Mis sesiones</h1>
         ...
         <div class="row">
          ...
          <?php
          $dni=$_SESSION['dni'];
            $result_tasks = mysqli_query($conexion, "SELECT * FROM sesiones
            inner join usuariots
            on usuariots.dni=sesiones.id_voluntario
             where id_voluntario='$dni'  ");
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center" >
                ...
                <div class="col mr-2"  >
                  ...
                  <div class="text-md font-weight-bold text-primary text-uppercase mb-4"><?php  echo $titulo;?></div>
                  <div class="text-xs font-weight-bold text-gray-500 text-uppercase mb-2">Voluntario:<?php  echo $nombre?></div>
                  <div class="h6 mb-0 font-weight-bold text-gray-500">Inicio:<?php  echo $row['fecha'];?> </div>
                </div>
                <div class="col-auto">
                  <i class="fas fa-eye fa-2x text-grey-1000" title="Ver Sesion"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-12 mb-4">
                  ...
                  <h6 class="m-0 font-weight-bold text-info" >CREA TU NUEVA SESIÓN : {{sesiones.titulo}}
                    ...
                    id="fecha" name="fecha" ng-init="sesiones.fecha='<?php echo date("yy-mm-dd"); ?>'" ng-model="sesiones.fecha">
                  </div>
                  </h6>
                 </div>
                 <div class="card-body">
                  <div class="row" style="text-align: center;">
                    ...
                    style="text-align: left;display:none;" id="id_volu" name="id_volu" ng-init="sesiones.id_volu='<?php echo $_SESSION['dni'];?>'" ng-model="sesiones.id_volu">
                      ...
                      style="text-align: left;" id="titulo" name="titulo" ng-init="sesiones.titulo=''" ng-model="sesiones.titulo">
                    </div>
                    </div>
                    <div class="col-lg-2 ">
                      ...
                      <div class="form-group">
                        ...
                        ng-init="sesiones.nro_horas='1.5'" ng-model="sesiones.nro_horas">
                      </div>
                      </div>
                      <div class="col-lg-3 ">
                        ...
                        <div class="form-group">
                          ...
                          id="finicio_ffinal" name="finicio_ffinal" ng-init="sesiones.finicio_ffinal='13:00-14:30'" ng-model="sesiones.finicio_ffinal">
                        </div>
                        <div class="form-group">
              ...
              <div class="card-body">
                  ...
                  <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <td>Dni</td>
                                <td>{{usuarios.dni}}</td>
                                <td>{{usuarios.p1}} {{usuarios.p2}} {{usuarios.a1}} {{usuarios.a2}} </td>
...
<div ng-switch-when="comentarios">
              ...
              <div class="row">
                  ...
                  <input type="text" ng-init="evaluacion.id_auto='1'" value="{{evaluacion.id_auto}}" style="display:none;">
      
                          <select id="inputState" class="form-control" ng-init="evaluacion.pre1=' '" ng-model="evaluacion.pre1">
                         
                            <option value="0" >No pasa nada 0%</option>
                  ...
                  <div class="col-lg-10 mb-4"><!-- Boton  de continuar-->
                   <button class="btn btn-info" ng-click="GuardarAutoevaluacion(evaluacion)">Terminar Nueva Sesion</button>
                  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="Dao/ofsesion.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered display " id="dataTable" width="100%" cellspacing="0 " >
              ...
              <tbody> 
                ...
                <tr ng-repeat="sesionesM in listasesiones">
                  <td style="display:none;"  ng-init="sesionesM.volu='<?php echo $_SESSION['dni'] ?>'"ng-model="sesionesM.volu"></td>
                  <td>{{$index +1}}</td>
